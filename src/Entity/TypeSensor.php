...
#[ORM\Entity(repositoryClass: TypeSensorRepository::class)]
class TypeSensor
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
     ...
     */
    #[ORM\OneToMany(targetEntity: Sensor::class, mappedBy: 'typeSensor', orphanRemoval: true)]
